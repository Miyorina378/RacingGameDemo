...
MAT_CARBON = make_material('carbon_fiber', 0x111315, metallic=0.45, roughness=0.42, coat=0.25)
...
# ==============================================================================
# AUTHENTIC TS020 BODY SHELL WITH VISIBLE CARBON UNDERCUT & COVERED WHEELS
# ==============================================================================
# Stations 0 to 23:
# At side stations (S10-S14):
# Col 6: Upper Red Door Shoulder (X ~ 0.88 - 0.90, Z ~ 0.72m)
# Col 7: Red Door Lower Crease under ESSO Ultron (X ~ 0.98m, Z ~ 0.46m) -> RED!
# Col 8: Deep Carbon Undercut Trough (X ~ 0.76 - 0.78m, Z ~ 0.21m) -> CARBON!
# Col 9: Carbon Floor Sill Edge (X ~ 0.985m, Z ~ 0.048m) -> CARBON!

STATIONS_3D = [
    # S0: Y = -2.48 (Front splitter beak)
    [
    ...
    # S3: Y = -1.75 (Leading solid vertical skirt)
    [
        (0.00, -1.75, 0.630), (0.09, -1.75, 0.615), (0.18, -1.75, 0.570), (0.28, -1.75, 0.440),
        (0.42, -1.75, 0.290), (0.58, -1.75, 0.420), (0.74, -1.75, 0.600), (0.87, -1.75, 0.745),
        (0.98, -1.75, 0.620), (0.99, -1.75, 0.048)
    ],
    # S4: Y = -1.65 (Front arch 1)
    [
        (0.00, -1.65, 0.645), (0.09, -1.65, 0.635), (0.19, -1.65, 0.590), (0.30, -1.65, 0.470),
        (0.44, -1.65, 0.340), (0.59, -1.65, 0.460), (0.74, -1.65, 0.630), (0.875, -1.65, 0.760),
        (0.982, -1.65, 0.710), (0.995, -1.65, 0.587)
    ],
    # S5: Y = -1.52 (Front arch forward 45 deg)
    [
        (0.00, -1.52, 0.670), (0.09, -1.52, 0.660), (0.20, -1.52, 0.625), (0.32, -1.52, 0.520),
        (0.46, -1.52, 0.420), (0.60, -1.52, 0.520), (0.74, -1.52, 0.665), (0.880, -1.52, 0.775),
        (0.985, -1.52, 0.735), (1.000, -1.52, 0.669)
    ],
    # S6: Y = -1.40 (Front arch apex directly over axle - Pontoon Crest Z = 0.785m!)
    [
        (0.00, -1.40, 0.690), (0.10, -1.40, 0.680), (0.22, -1.40, 0.650), (0.34, -1.40, 0.550),
        (0.46, -1.40, 0.480), (0.60, -1.40, 0.560), (0.74, -1.40, 0.690), (0.880, -1.40, 0.785),
        (0.985, -1.40, 0.745), (1.000, -1.40, 0.690)
    ],
    # S7: Y = -1.28 (Front arch rear 45 deg)
    [
        (0.00, -1.28, 0.700), (0.10, -1.28, 0.690), (0.23, -1.28, 0.662), (0.35, -1.28, 0.585),
        (0.47, -1.28, 0.520), (0.61, -1.28, 0.585), (0.74, -1.28, 0.680), (0.875, -1.28, 0.775),
        (0.982, -1.28, 0.735), (1.000, -1.28, 0.669)
    ],
    # S8: Y = -1.15 (Front arch rear slope)
    [
        (0.00, -1.15, 0.712), (0.10, -1.15, 0.702), (0.23, -1.15, 0.675), (0.35, -1.15, 0.615),
        (0.47, -1.15, 0.565), (0.61, -1.15, 0.610), (0.74, -1.15, 0.675), (0.870, -1.15, 0.755),
        (0.980, -1.15, 0.705), (0.995, -1.15, 0.587)
    ],
    # S9: Y = -1.05 (Front arch trailing lip / extractor entry)
    [
        (0.00, -1.05, 0.720), (0.11, -1.05, 0.710), (0.24, -1.05, 0.685), (0.36, -1.05, 0.635),
        (0.48, -1.05, 0.595), (0.62, -1.05, 0.625), (0.74, -1.05, 0.675), (0.860, -1.05, 0.735),
        (0.975, -1.05, 0.675), (0.990, -1.05, 0.394)
    ],
    # S10: Y = -0.95 (Air extractor drop to side pod - visible carbon undercut begins!)
    [
        (0.00, -0.95, 0.724), (0.11, -0.95, 0.715), (0.25, -0.95, 0.695), (0.37, -0.95, 0.655),
        (0.49, -0.95, 0.615), (0.63, -0.95, 0.540), (0.880, -0.95, 0.715), (0.978, -0.95, 0.460),
        (0.780, -0.95, 0.220), (0.985, -0.95, 0.048)
    ],
    # S11: Y = -0.55 (Forward door - ESSO Ultron red shelf above deep carbon cove)
    [
        (0.00, -0.55, 0.730), (0.12, -0.55, 0.724), (0.26, -0.55, 0.715), (0.38, -0.55, 0.695),
        (0.50, -0.55, 0.660), (0.64, -0.55, 0.520), (0.890, -0.55, 0.720), (0.980, -0.55, 0.460),
        (0.760, -0.55, 0.200), (0.985, -0.55, 0.048)
    ],
    # S12: Y = 0.00 (Mid door - prominent carbon undercut visible on side profile!)
    [
        (0.00,  0.00, 0.738), (0.12,  0.00, 0.732), (0.26,  0.00, 0.722), (0.38,  0.00, 0.708),
        (0.50,  0.00, 0.675), (0.66,  0.00, 0.550), (0.900,  0.00, 0.725), (0.980,  0.00, 0.460),
        (0.760,  0.00, 0.200), (0.985,  0.00, 0.048)
    ],
    # S13: Y = +0.55 (Rear sidepod / radiator shoulder)
    [
        (0.00,  0.55, 0.750), (0.11,  0.55, 0.744), (0.22,  0.55, 0.734), (0.36,  0.55, 0.712),
        (0.50,  0.55, 0.675), (0.66,  0.55, 0.630), (0.900,  0.55, 0.735), (0.980,  0.55, 0.470),
        (0.780,  0.55, 0.220), (0.985,  0.55, 0.048)
    ],
    # S14: Y = +0.95 (Rear sill transition to rear wheel arch)
    [
        (0.00,  0.95, 0.755), (0.09,  0.95, 0.750), (0.18,  0.95, 0.735), (0.32,  0.95, 0.680),
        (0.48,  0.95, 0.630), (0.65,  0.95, 0.670), (0.870,  0.95, 0.745), (0.978,  0.95, 0.480),
        (0.820,  0.95, 0.250), (0.985,  0.95, 0.048)
    ],
    # S15: Y = +1.05 (Rear arch leading lip)
    [
        (0.00,  1.05, 0.750), (0.08,  1.05, 0.745), (0.16,  1.05, 0.730), (0.30,  1.05, 0.660),
        (0.46,  1.05, 0.600), (0.64,  1.05, 0.680), (0.78,  1.05, 0.745), (0.860,  1.05, 0.755),
        (0.975,  1.05, 0.690), (0.990,  1.05, 0.394)
    ],
    # S16: Y = +1.15 (Rear arch forward slope)
    [
        (0.00,  1.15, 0.740), (0.08,  1.15, 0.735), (0.15,  1.15, 0.720), (0.29,  1.15, 0.650),
        (0.45,  1.15, 0.585), (0.65,  1.15, 0.680), (0.78,  1.15, 0.750), (0.860,  1.15, 0.770),
        (0.975,  1.15, 0.715), (0.995,  1.15, 0.587)
    ],
    # S17: Y = +1.28 (Rear arch forward 45 deg)
    [
        (0.00,  1.28, 0.725), (0.07,  1.28, 0.720), (0.13,  1.28, 0.705), (0.27,  1.28, 0.635),
        (0.44,  1.28, 0.565), (0.65,  1.28, 0.680), (0.78,  1.28, 0.760), (0.860,  1.28, 0.785),
        (0.975,  1.28, 0.740), (0.995,  1.28, 0.669)
    ],
    # S18: Y = +1.40 (Rear arch apex directly over axle - Haunch Crest Z = 0.790m!)
    [
        (0.00,  1.40, 0.710), (0.06,  1.40, 0.705), (0.12,  1.40, 0.695), (0.26,  1.40, 0.620),
        (0.44,  1.40, 0.550), (0.66,  1.40, 0.680), (0.78,  1.40, 0.765), (0.860,  1.40, 0.790),
        (0.975,  1.40, 0.745), (0.995,  1.40, 0.690)
    ],
    # S19: Y = +1.52 (Rear arch rear 45 deg)
    [
        (0.00,  1.52, 0.695), (0.06,  1.52, 0.690), (0.12,  1.52, 0.680), (0.26,  1.52, 0.610),
        (0.44,  1.52, 0.540), (0.66,  1.52, 0.670), (0.78,  1.52, 0.760), (0.855,  1.52, 0.778),
        (0.972,  1.52, 0.735), (0.995,  1.52, 0.669)
    ],
    # S20: Y = +1.65 (Rear arch rear slope)
    [
        (0.00,  1.65, 0.680), (0.06,  1.65, 0.675), (0.12,  1.65, 0.665), (0.26,  1.65, 0.595),
        (0.44,  1.65, 0.525), (0.66,  1.65, 0.655), (0.79,  1.65, 0.750), (0.850,  1.65, 0.760),
        (0.965,  1.65, 0.700), (0.990,  1.65, 0.587)
    ],
    # S21: Y = +1.75 (Rear arch trailing lip)
    [
        (0.00,  1.75, 0.665), (0.06,  1.75, 0.660), (0.12,  1.75, 0.650), (0.26,  1.75, 0.585),
        (0.44,  1.75, 0.515), (0.66,  1.75, 0.645), (0.80,  1.75, 0.740), (0.850,  1.75, 0.745),
        (0.960,  1.75, 0.620), (0.985,  1.75, 0.394)
    ],
    # S22: Y = +2.05 (Rear deck slope)
    [
        (0.00,  2.05, 0.625), (0.05,  2.05, 0.620), (0.10,  2.05, 0.610), (0.26,  2.05, 0.550),
        (0.46,  2.05, 0.490), (0.64,  2.05, 0.580), (0.78,  2.05, 0.660), (0.880,  2.05, 0.540),
        (0.930,  2.05, 0.320), (0.950,  2.05, 0.150)
    ],
    # S23: Y = +2.40 (Rear tail bulkhead)
    [
        (0.00,  2.40, 0.570), (0.05,  2.40, 0.565), (0.10,  2.40, 0.555), (0.26,  2.40, 0.510),
        (0.46,  2.40, 0.450), (0.62,  2.40, 0.520), (0.74,  2.40, 0.580), (0.860,  2.40, 0.420),
        (0.900,  2.40, 0.280), (0.920,  2.40, 0.240)
    ],
]
...
# Generate ALL body shell quads with authentic two-tone: Red upper body, Black Carbon lower undercut!
for s in range(n_s - 1):
    for c in range(n_c - 1):
        ...
        # Authentic Le Mans Side Carbon Undercut:
        # At side stations S10 through S14, columns 7 and 8 form the deep black carbon side channel!
        if (10 <= s <= 13) and (c >= 7):
            f.material_index = 2 # Carbon Fiber undercut (clearly visible on side!)
        elif (s == 9) and (c >= 7):
            f.material_index = 2 # Extractor transition to carbon
        elif (s == 14) and (c >= 7):
            f.material_index = 2 # Carbon transition to rear arch
        else:
            f.material_index = 0 # 100% Super Red paint
...
for s in range(n_s - 1):
    if (4 <= s <= 8) or (16 <= s <= 20):
        v_tub1 = bm_body.verts.new((0.65, STATIONS_3D[s][0][1], 0.048))
        v_tub2 = bm_body.verts.new((0.65, STATIONS_3D[s+1][0][1], 0.048))
...
# Inner Wheel Arch Tub Liners
def build_wheel_liner(s_start, s_end, inner_x=0.68):
    for s in range(s_start, s_end):
        v_lip1 = grid_verts[s][9]
        v_lip2 = grid_verts[s+1][9]
        v_in1 = bm_body.verts.new((inner_x, v_lip1.co.y, v_lip1.co.z))
        v_in2 = bm_body.verts.new((inner_x, v_lip2.co.y, v_lip2.co.z))
        f = bm_body.faces.new((v_lip1, v_lip2, v_in2, v_in1))
        f.material_index = 2 # Carbon

build_wheel_liner(3, 9, inner_x=0.68)   # Front wheel liner
build_wheel_liner(15, 21, inner_x=0.66) # Rear wheel liner

# Creases for crisp body definition
bm_body.edges.ensure_lookup_table()
crease_layer = bm_body.edges.layers.float.new('crease_edge')

# Rocker panel sill bottom crease - DEAD FLAT along the road
for s in (0, 1, 2, 10, 11, 12, 13, 22):
    e = bm_body.edges.get((grid_verts[s][9], grid_verts[s+1][9]))
    if e:
        e[crease_layer] = 0.95

# Crisp circular wheel arch rim lips
for s in (3, 4, 5, 6, 7, 8, 15, 16, 17, 18, 19, 20):
    e = bm_body.edges.get((grid_verts[s][9], grid_verts[s+1][9]))
    if e:
        e[crease_layer] = 0.70

# Crisp F1 nose keel shoulder
for s in range(4):
    e = bm_body.edges.get((grid_verts[s][2], grid_verts[s+1][2]))
    if e:
        e[crease_layer] = 0.70

# Crisp nose valley trough
for s in range(4):
    e = bm_body.edges.get((grid_verts[s][4], grid_verts[s+1][4]))
    if e:
        e[crease_layer] = 0.50

# Crisp horizontal crease line between red door and black carbon undercut
for s in (10, 11, 12, 13):
    e = bm_body.edges.get((grid_verts[s][7], grid_verts[s+1][7]))
    if e:
        e[crease_layer] = 0.85

# Crisp undercut trough crease
for s in (10, 11, 12, 13):
    e = bm_body.edges.get((grid_verts[s][8], grid_verts[s+1][8]))
    if e:
        e[crease_layer] = 0.70
...
# Rear Diffuser Vertical Strakes
...
# Teardrop Mirrors
for sign in (-1, 1):
    m_base = (sign * 0.86, -1.22, 0.76)
    m_head = (sign * 0.94, -1.16, 0.84)
...
for sign in (-1, 1):
    ...
    for i in range(4):
        ...
        bmesh.ops.translate(bm_lv, vec=(sign * 0.88, ly, 0.780), verts=bm_lv.verts)
...
# Vertical Endplates (Tall red endplates matching reference photo)
ep_pts = [
...
print(">> SUCCESS: Authentic Toyota GT-One Masterpiece exported with prominent side carbon undercut!")
