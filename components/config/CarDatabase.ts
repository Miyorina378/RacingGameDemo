...
export const CARS_DATABASE: CarConfig[] = [
  ...
  },
  {
    ...
    throttleResponse: 12.0,
    engineCoolingEfficiency: 1.25,
    fuelCapacityLiters: 90,
    fuelTankLongitudinalPosition: 0.0,
    fuelTankHeight: 0.22,
    brakeSpecificFuelConsumption: 285,
    hasSpoiler: true,
    ...
    tireGripFront: 1.25,
    tireGripRear: 1.35,
    corneringStiffnessFront: 8.2,
    corneringStiffnessRear: 8.6,
    frontCamberDegrees: -2.5,
    rearCamberDegrees: -1.8,
    tireColdPressurePsi: 28,
    brakeForce: 26000,
    maxSteeringAngle: 0.48,
    steeringRackRatio: 13.2,
    powerSteeringType: 'hydraulic',
    pneumaticTrail: 0.055,
    casterTrail: 0.035,
    ...
    gearRatios: [0, 2.93, 2.06, 1.58, 1.26, 1.04, 0.88],
    finalDrive: 3.44,
    wheelRadius: 0.335,
    shiftUpMph: [62, 88, 115, 144, 175],
    torqueCurve: [
      { rpm: 2000, torque: 380 },
      { rpm: 4000, torque: 580 },
      { rpm: 6000, torque: 650 },
    ...
    visualLength: 4.84,
    visualScale: 1.0,
    driverCameraOffset: { x: 0, y: 0.45, z: 0.40 },
    character: { weightDistribution: 0.44, rearGripMultiplier: 1.25, yawInertia: 0.78, oversteerResistance: 0.55 }
  }
];
